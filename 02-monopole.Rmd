...
Il va choisir **un** des paramètres du couple $(q, P(q))$, et l'autre en découlera, à travers la demande $P(q)$.
...
En CPP, la recette totale du producteur individuel était $R(q) = q\cdot P(q^*)$, où $x$ est sa production individuel, $q^*$ la quantité d'équilibre sur le marché (résultat de la production de *toutes* les entreprises présentes sur le marché) et $P(q^*)=p^*$ est le prix d'équilibre.
...
```{r monopoleelasticite, fig.cap="Elasticité et profit."}
p2 <- p;
