...
La courbe de demande correspond à la suite des prix de réserve des individus, c'est-à-dire aux prix maximaux que chaque individu est prêt à payer pour obtenir une unité *supplémentaire* du bien.
...
Sur le graphique quantité prix $(q, p)$, c'est l'aire comprise entre la courbe de demande est la droite horizontale dont l'ordonnée est le prix d'échange.
Formellement :
