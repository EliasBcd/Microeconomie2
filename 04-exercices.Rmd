...
1. Question préliminaire. Soit une fonction de demande donnée par:
...
Comme leur coût de production est identique, ces deux entreprises sont symétriques, tout ce qu'on écrira pour l'une peut s'écrire pour l'autre en changeant ce qu'il faut changer.
    b. On commence par écrire le profit de l'entreprise 1 :
...
Ici, contrairement à précédemment, $q_B$ dépend de $q_A$ et B le sait, il va donc prendre en compte cette dépendance :
\begin{align*}
...
\pi_B=60\times 6 = 360
\end{gather*}
    c. Le profit est plus élevé en Stackelberg pour A, mais plus faible pour B.
Malgré la totale symétrie de A et B en dehors de leur entrée sur le marché, ce seul fait profite à A, qui exploite son avantage afin d'augmenter son profit.
:::
...
1. Supposons que les entreprises signent un accord de cartel pour produire conjointement la quantité correspondant à la situation de monopole. Quelle est la quantité que devrait produire chaque firme si elle respectait cet accord et quel serait alors le prix d'équilibre? 
