...
\hypertarget{le-consommateur}{%
\section{Le consommateur}\label{le-consommateur}}

Notre modélisation des consommateurs sera assez simple dans ce cours.

\begin{definition}[Demande individuelle]
La fonction de demande d'un consommateur correspond à la suite des prix maximaux qu'un consommateur est prêt à payer pour obtenir une unité \emph{supplémentaire} du bien.
On la note souvent \(Q\).
\end{definition}

On appelle ce prix maximum le \emph{prix de réserve}.

\begin{proposition}[Variation de la fonction de demande]
...
\begin{remark}[Demande et demande inverse]
