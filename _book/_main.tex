...
L'\emph{offre agrégée (S)} est la omme des offres individuelles pour chaque niveau de prix.
\end{definition}
...
\tightlist
\item
  La fonction d'offre des entreprises en concurrence pure et parfaite est égale à la fonction de coût marginal.
