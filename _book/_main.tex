...
\item
  ...
  \[C'_m(q)=8>R_m'(q)\]
  La condition du second est bien vérifiée, nous avons bien un maximum ici.
  Le prix est \(p^*=P(q^*)=33\).
  Finalement, on peut calculer le profit :
  \[
  \pi(q^*)=R(q^*)-C(q^*)=p^*q^*-C(q^*)=24\times226-(4\times24^2+10\times24+400)=2480>0
  \]
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/monoexo3-1.pdf}
\caption{\label{fig:monoexo3}Représentation graphique}
\end{figure}
