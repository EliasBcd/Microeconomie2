...
#| fig-cap: "Courbes d'isoprofits du leader et fonctions de réactions des entreprises en équilibre de Stackelberg."
p <- p_isoprofit
...
Sur la @fig-Stack-equi, on voit que le profit du leader est plus important en Stackelberg qu'en Cournot (et l'inverse pour le follower).
...
Comme l'entreprise leader connaît la fonction de réaction de l'entreprise follower (donnée par l'@eq-FRFollower), elle peut l'intégrer à sa propre fonction de profit :
