...
L'indice de Lerner du marché est ainsi la moyenne pondérée par les parts de marchés des indices de Lerner de chaque producteur.
...
p_stackelberg <- ggplot() +
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1.2), breaks=c(.25, 1/3, 0.5), labels=c(expression(q["2C"]^"*"), expression(q["1F"]^"*"), expression(q["2m"]^"*"))) +
